...
var DEventData, DEventEmitter, WORKERS, cluster, devents, main, messages, startMaster, startWorker, _ref;

cluster = require("cluster");

_ref = devents = require("../devents"), DEventEmitter = _ref.DEventEmitter, DEventData = _ref.DEventData;
...
startWorker = function() {
  var emitter, i, options, _i, _j, _results;
  ...
  _results = [];
  for (i = _j = 1; 1 <= WORKERS ? _j <= WORKERS : _j >= WORKERS; i = 1 <= WORKERS ? ++_j : --_j) {
    if (i !== cluster.worker.id) {
